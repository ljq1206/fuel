...
public interface SensorDatasService {
    ...
    //设备月查询
    public int DeviceMonthOne();//七天查询第一天
    public int DeviceMonthTwo();//七天查询第er天
    public int DeviceMonthThree();//七天查询第san天
    public int DeviceMonthFour();//七天查询第si天
