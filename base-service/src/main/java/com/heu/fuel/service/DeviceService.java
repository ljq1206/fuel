...
public interface DeviceService {
    ...
    public int FaultStatus(String device_code);//设备故障状态

    public int WarningStatus(String device_code);//设备预警状态
    ...
    public int GetDeviceFaultCount( Integer id, Integer date);//获取设备故障数量

    public int GetDeviceWarningCount( Integer id,Integer date);//获取设备预警数量

    public List<Integer> GetDeviceId();//获取设备id

    public String GetDeviceName(Integer id);//获取设备名称
