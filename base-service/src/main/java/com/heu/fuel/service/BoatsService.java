...
public interface BoatsService {
    public List<Boats> queryAll(String find_key,String find_value,String sort_key,String sort_value); //查找所有
    ...
    public int GetBoatsFaultCount(Integer id,Integer date);//获取船只故障数量

    public int GetBoatsWarningCount(Integer id,Integer date);

    public List<Integer> GetBoatId();//获取船只id

    public String GetBoatName(Integer id);//获取船只名称


    public int insertBoat(Boats boats);//添加
    ...
    public int updateDeviceByBoat();//根据boat更新设备
