...
public interface FaultRecordDatasService {
    ...
    public int NotDealFaultCount(String device_code);  //获取当前设备未处理故障数量
    public int DealFaultCount(String device_code);  //获取当前设备已处理故障数量
    public int FaultTotal(String device_code);  //获取当前设备已处理故障数量
